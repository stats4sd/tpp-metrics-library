...
use Filament\Forms\Components\Concerns\HasNestedRecursiveValidationRules as HasNestedRecursiveValidationRulesConcern;
...
class CheckboxList extends Field implements HasNestedRecursiveValidationRules
{
    use CanBeSearchable;
    use HasNestedRecursiveValidationRulesConcern;
    use HasOptions;
    use HasAffixes;
