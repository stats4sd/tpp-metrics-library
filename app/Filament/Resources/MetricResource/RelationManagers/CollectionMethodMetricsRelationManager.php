...
class CollectionMethodMetricsRelationManager extends RelationManager
{
    ...
    {
        return 'Metrics for ' . $this->ownerRecord->title;
    }
        ...
        return $form
            ->schema([
                ...
                Textarea::make('relation_notes')
                    ->label('Add any extra information about why this metric is associated to the collection method')
                    ->columnSpan(2),
            ]);
    }
