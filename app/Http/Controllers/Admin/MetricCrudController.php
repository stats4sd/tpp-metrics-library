...
class MetricCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('parent_child_notes');
        CRUD::column('title');
        CRUD::column('developer_id');
        CRUD::column('definition');
        CRUD::column('concept');
        CRUD::column('scale_notes');
        CRUD::column('notes');
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('parent_child_notes');
        CRUD::field('title');
        CRUD::field('developer_id');
        CRUD::field('definition');
        CRUD::field('concept');
        CRUD::field('scale_notes');
        CRUD::field('notes');
